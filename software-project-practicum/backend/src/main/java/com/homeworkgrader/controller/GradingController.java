...
import com.homeworkgrader.service.StudentAnalysisService;
...
public class GradingController {
    ...
    public GradingController(
            CrudJdbcRepository repository,
            GradingResultImportService resultImportService,
            GradingWorkflowService workflowService,
    ...
    public ApiResponse<?> finalResultAnalysisDetail(@PathVariable Long id) throws FileNotFoundException {
        return ApiResponse.ok(studentAnalysisService.getAnalysisDetail(id));
    }
